...
The default values are set according to REP 105 [#REP-105].
...
According to REP 105 [#REP-105], the following transformations shall be
...
According to REP 105 [#REP-105], the SLAM nodes must provide at least 
this transform.
