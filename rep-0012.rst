...
- If there is a mailing list for discussion of your new feature, add a
  ...
  ros-users@code.ros.org or ros-developers@code.ros.org, or if discussions
...
- Send your REP submission to the ROS developers at ros-developers@code.ros.org.
...
.. [2] REP 9, Sample Plaintext REP Template, Warsaw
   (http://ros.org/reps/pep-0009.html)
