...
:: 
    ...
    +-------------+  +--------------+----+---------+-----------------------------------+---------------+
    |             |  |   ament_sol1 | ament_soln   |                  |  accel_fw_sol1 | accel_fw_soln |
    |             |  +--------------+--------------+------------------+----------------+---------------+
    |  tooling    |  |     ament_acceleration   | colcon_acceleration |       acceleration_firmware    |
    |             |  +---------------------------------------------------------------------------------+
...
By splitting vendors across packages with a common front-end (``acceleration_firmware``), consumers and maintainers can easily switch between hardware acceleration solutions.
