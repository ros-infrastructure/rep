 ...
 * `ros-build-essential`: The `ros-build-essential` ROS distribution independent variant includes only the packages that are required for building and compiling ROS 2 packages.
...
::
 ...
 - ros-build-essential:
 - ros-build-essential:
      packages: [cmake, git, python3-setuptools, wget]
