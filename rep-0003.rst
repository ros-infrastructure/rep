...
ROS Hydro also supports Precise and Quantal. Both provide a default
Python 2.7 interpreter with Python 3.2 as an option. To work
bilingually on all these distributions, the core Python scripts and
tools need to be compatible with Python 2.7, 3.2 and 3.3. ROS package
developers can begin porting to Python 3.x, as soon as their
dependencies all work with that version.

Python 3.0 and 3.1 are *not* explicitly supported, although some
things may work.
