...
As of Raring Ubuntu ships with Python 3 by default.  While ROS still
supports Ubuntu versions which ship with Python 2, all core Python
scripts and tools should provide dual compatibility with both Python
2.7+ and Python 3.3+.
...
systems.  But, ROS package developers can begin porting to Python 3,
if their dependencies are available in that version.
