...
As of Raring, Ubuntu ships with Python 3 as its default interpreter.
ROS also supports systems which with a default Python 2
interpreter. All core Python scripts and tools should be compatible
with both Python 2.7 and Python 3.3.
...
if their dependencies all work with that version.
