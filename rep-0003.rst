...
Note that Gazebo is a special case, since it spans versions 7, 8, and 9.  Since Bionic is the only LTS required support platform for Melodic, all packages should target Gazebo 9.  Packages are encouraged to additionally support Gazebo 7, but it is not required.
