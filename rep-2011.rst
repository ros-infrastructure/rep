...
This approach does not rely on specific features of the serialization technology and instead relies on the ability to communicate the full type descriptions on the wire, beyond their name and version, and use that description to introspect the values of it at runtime.
...
.. TODO:: cite the ros1_bridge rules and the rosbag migration rules
...
- enforcing type compatibility by version
  ...
  - by providing type versions as hashes for types automatically
  - and providing access to the type versions used by remote endpoints
