...
Crystal Clemmys (December 2018 - TBD, at least December 2019)
-------------------------------------
...
Tier 2 platforms are subject to ad hoc testing and binary packages or archives may not be provided or supported.
However users should note that errors may be present in released product versions for Tier 2 platforms and, subject to resource availability, known errors in Tier 2 platforms may or may not be corrected prior to new version releases.

Tier 3

All platforms not specifically listed above.
We neither run the unit test suite nor perform any other tests on platforms not listed above.
We expect installation instructions to be present and up-to-date in order for a platform to be listed in this category.
Other community members might provide assistance with these platforms.
...
+--------------------+-------------+---------------+---------------------------------+---------------------------------------+
| Middleware         | Version     | Support Level | Platforms                       | Architectures                         |
+====================+=============+===============+=================================+=======================================+
| eProsima Fast-RTPS | latest, TBD | Tier 1        | All Tier 1 Platforms            | All Tier 1 Architectures              |
+--------------------+-------------+---------------+---------------------------------+---------------------------------------+
| eProsima Fast-RTPS | latest, TBD | Tier 2        | All Tier 2 Platforms            | All Tier 2 Architectures              |
+--------------------+-------------+---------------+---------------------------------+---------------------------------------+
| RTI Connext        | latest, TBD | Tier 1        | All Tier 1 Platforms            | All Tier 1 Architectures except arm64 |
+--------------------+-------------+---------------+---------------------------------+---------------------------------------+
| RTI Connext        | latest, TBD | Tier 2        | All Tier 2 Platforms            | All Tier 2 Architectures except arm64 |
+--------------------+-------------+---------------+---------------------------------+---------------------------------------+
| ADLink OpenSplice  | latest, TBD | Tier 2        | All Tier 1 and Tier 2 platforms | All Tier 1 and Tier 2 architectures   |
+--------------------+-------------+---------------+---------------------------------+---------------------------------------+
