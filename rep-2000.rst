...
Author: Mikael Arguedas <mikael@openrobotics.org>, Steven! Ragnarök <steven@openrobotics.org>
Status: Active
Type: Informational
...
+--------------------------+---------------------+---------------+-----------------------------+--------------------------------+
| rmw_fastrtps_shared_cpp  | eProsima Fast-RTPS  | Tier 2        | All Platforms               | All Architectures              |
| rmw_fastrtps_dynamic_cpp | eProsima Fast-RTPS  | Tier 2        | All Platforms               | All Architectures              |
+--------------------------+---------------------+---------------+-----------------------------+--------------------------------+
|  rmw_connext_shared_cpp  | RTI Connext         | Tier 2        | All platforms except Debian | All architectures except arm64 |
