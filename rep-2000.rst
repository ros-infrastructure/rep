...
Author: Mikael Arguedas <mikael@openrobotics.org>, Steven! Ragnarok <steven@openrobotics.org>, Dirk Thomas <dthomas@openrobotics.org>, Audrow Nash <audrow@openrobotics.org>, Geoffrey Biggs <geoff@openrobotics.org>
Status: Active
Type: Informational
...
+--------------+------------------+---------------+------------------+-------------+-----------------+----------------+----------------+
| Architecture | Ubuntu Jammy     | Windows 10    | RHEL 9           |  macOS      | Debian Bullseye | OpenEmbedded / | Fedora 38      |
|              | (22.04)          | (VS2022)      |                  |             | (11)            | webOS OSE      |                |
+==============+==================+===============+==================+=============+=================+================+================+
|    amd64     | Tier 1 [d][a][s] | Tier 1 [a][s] | Tier 2 [d][a][s] |  Tier 3 [s] |   Tier 3 [s]    |                | Tier 3 [s]     |
+--------------+------------------+---------------+------------------+-------------+-----------------+----------------+----------------+
|    arm64     | Tier 1 [d][a][s] |               |                  |             |   Tier 3 [s]    |   Tier 3 [s]   |                |
...
|             |        Required Support         |                        Recommended Support                                    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Package     |  Ubuntu Jammy  |  Windows 10**  |  RHEL 9  |    macOS**    | Debian Bullseye  |   OpenEmbedded**    | Fedora 38 |
+=============+================+================+==========+===============+==================+=====================+===========+
| CMake       |     3.22.1     |     3.22.0     |  3.20.2  |    3.14.4     |      3.18.4      | 3.22.3 / 3.16.5***  | 3.26.3    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| EmPY        |      3.3.4     |     3.3.2      |   3.3.4  |                     3.3.2                              | 3.3.4a    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Gazebo      |    11.x.x*     |       N/A      |   N/A    |    11.x.x     |      11.x.x*     |         N/A         | 10.1.0    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Ignition    |    Fortress*   |       N/A      |   N/A    |   Fortress*   |     Fortress*    |         N/A         | N/A       |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| NumPy       |     1.21.5     |     1.18.4     |  1.20.1  |     1.18.4    |     1.19.5       |         N/A         | 1.22.0    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Ogre        |                                     1.12.1*                                   |         N/A         | 1.9.0     |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| OpenCV      |     4.5.4      |     4.5.4      |  4.6.0   |     4.2.0     |      4.5.1       |  4.1.0 / 3.2.0***   | 4.6.0     |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| OpenSSL     |     3.0.2      |     1.1.1l     |  3.0.1   |     1.1.1f    |      1.1.1i      | 1.1.1d / 1.1.1b***  | 3.0.8     |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Python      |     3.10.6     |     3.8.3      |  3.9.14  |     3.10.8    |      3.9.1       |  3.8.2 / 3.7.5***   | 3.11.2    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Qt          |     5.15.3     |    5.12.10     |  5.15.3  |     5.12.3    |      5.15.2      | 5.14.1 / 5.12.5***  | 4.8.7     |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
|                              |                                   **Linux only**                                   |           |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| PCL         |     1.12.1     |      N/A       |  1.12.0  |      N/A      |      1.11.1      |       1.10.0        | 1.12.0    |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
|                                         **RMW DDS Middleware**                                                    |           |
+-------------+----------------+----------------+----------+---------------+------------------+---------------------+-----------+
| Cyclone DDS |                                          0.9                                                        | N/A       |
