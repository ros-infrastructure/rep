...
Tier 1 platforms are subjected to our unit test suite and other internal testing tools on a frequent basis including continuous integration jobs, nightly jobs, packaging jobs, and performance testing.
...
Tier 2 platforms are subject to ad hoc and internal testing and binary packages or archives may not be provided or supported.
...
All platforms not specifically listed above are not supported by us.
We neither run the unit test suite nor perform any other internal tests on platforms not listed above.
...
- eProsima Fast-RTPS
  Version: TBD
  Tier 1 support on all Tier 1 platforms and architectures.

- RTI Connext
  Version: 5.3.1
  Tier 1 support on all Tier 1 platforms and architectures except arm64.

- ADLink OpenSplice
  Version: 6.7
  Tier 2 support on all Tier 1 and Tier 2 platforms and architectures.
