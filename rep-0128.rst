...
::
    ...
    workspace_folder/        --WORKSPACE
      src/                   --SOURCE SPACE
        ...
        ...
        package_n/
          CATKIN_IGNORE      --Optionally place this marker file to exclude package_n from being processed. Its file type (e.g. regular file, directory) and contents are ignored.
          CMakeLists.txt
          package.xml
