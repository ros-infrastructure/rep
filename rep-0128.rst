...
::
    ...
    workspace_folder/        --WORKSPACE
      src/                   --SOURCE SPACE
        ...
        ...
        package_n/
          CATKIN_IGNORE      --Optionally place this marker file to exclude package_n from being processed. Its file type (e.g. regular file, directory) and contents don't matter.
          CMakeLists.txt
          package.xml
