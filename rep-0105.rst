...
If the map is being constructed dynamically (SLAM) and absolute heading is unknown it is recommended to take a best estimate of ENU with at least up being as accurately aligned as possible.
