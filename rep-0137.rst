...
* repositories: a list of repositories which are identified by unique names
  ...
  * version: version number for which packages are released. For git and hg this
...
Distribution file
-----------------
A distribution file listing repositories and packages and the target platforms.
...
Full ROS build
--------------
This corresponds to building ROS for officially supported platforms and
architectures. This example shows the different files needed for ROS groovy.
...
::
  ...
  distributions:
    groovy:
      release: release/groovy.yaml
      release-build: [release/groovy-build.yaml]
      test: test/groovy.yaml
      test-build: [test/groovy-build.yaml]
      doc: doc/
      distribution-cache: http://ros.org/rosdistro/groovy-cache.tar.gz
...
::
  ...
  repositories:
    ...
    # here the contents of the current groovy.yaml:repositories
...
::
  ...
  repositories:
    ...
    # here the contents of the current groovy-devel.yaml:repositories
